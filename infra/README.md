...
#### 3. Save the OCI PostgreSQL CA certificate
...
#### 4. Create the Bastion port-forwarding session
...
#### 5. Copy the Vault password without printing it
...
#### 7. Close and delete the session
